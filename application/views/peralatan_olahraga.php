<div class="container-fluid">
    ...
    <div class="row text-center mt-4">
        ...
        <?php foreach ($peralatan_olahraga as $barang) : ?>
            ...
            <div class="card ml-3 mb-3" style="width: 16rem;">
                ...
                <div class="card-body">
                    ...
                    <span class="badge badge-pill badge-success mb-3">Rp. <?php echo number_format($barang->harga, 0,',','.')  ?></span>
                    <?php echo anchor('dashboard/tambah_ke_keranjang/' .$barang->id_barang, '<div class="btn btn-sm btn-primary">Tambah ke Keranjang</div>') ?>
                    <?php echo anchor('dashboard/detail/' .$barang->id_barang, '<div class="btn btn-sm btn-success">Detail</div>') ?>
                </div>
            </div>
